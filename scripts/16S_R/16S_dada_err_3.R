...
filt_out<-filt_out[,-1] # remove the blank column
...
# inspect data
# 8865189 reads in 2055594 unique sequences.
# 569 sequence variants were inferred from 4987 input unique sequences.
...
# 0.9729083 cleared
# Identified 2946 bimeras out of 12139 input sequences.
